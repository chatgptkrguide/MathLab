...
import 'widgets/hearts_depleted_dialog.dart';
import 'widgets/hearts_indicator.dart';
import 'widgets/lesson_not_ready_dialog.dart';
...
class _ProblemSolvingScreenState extends ConsumerState<ProblemSolvingScreen>
  ...
  void _showFailureScreen() {
    ...
    showHeartsDepletedDialog(context: context, gems: gems);
  }

  void _showLessonNotReadyDialog() {
    showLessonNotReadyDialog(
      context: context,
      onDismiss: () {
