...
class _OnboardingProfileSetupScreenState
  ...
  bool _canProceed() {
    Logger.info('_canProceed called: page=$_currentPage, nameText="${_nameController.text}", length=${_nameController.text.length}', tag: 'OnboardingProfileSetup');
    switch (_currentPage) {
      case 0: // 이름
        final canProceed = _nameController.text.trim().length >= 2;
        Logger.info('Page 0 check: canProceed=$canProceed', tag: 'OnboardingProfileSetup');
        return canProceed;
      case 1: // 생년월일
  ...
  void _updateBirthDate() {
    if (_selectedBirthYear != null && _selectedBirthMonth != null && _selectedBirthDay != null) {
      try {
        setState(() {
          _selectedBirthDate = DateTime(_selectedBirthYear!, _selectedBirthMonth!, _selectedBirthDay!);
        });
      } catch (e) {
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _canProceed()
                        ? () {
                            Logger.info('Button tapped: page=$_currentPage', tag: 'OnboardingProfileSetup');
                            if (_currentPage == _totalPages - 1) {
                              _saveProfile();
                            } else {
                              _nextPage();
                    ...
                    child: _isLoading
                        ...
                        : Row(
                            ...
                            children: [
                              Text(
                                _currentPage == _totalPages - 1 ? '🚀 시작하기' : '계속하기',
                  ...
                  content: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: const UnderlineInputBorder(
                        borderSide: BorderSide(color: AppColors.mathBlue, width: 2),
                      ),
                    ),
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<int>(
                                  ...
                                  isExpanded: true,
                                  icon: Icon(Icons.arrow_drop_down, color: AppColors.textSecondary, size: 28),
                                  style: AppTextStyles.bodyLarge.copyWith(
                                    color: AppColors.textPrimary,
                                    fontSize: 18,
                                  ),
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<int>(
                                  ...
                                  onChanged: (value) {
                                    setState(() => _selectedBirthMonth = value);
                                    _updateBirthDate();
                                  },
                                ),
                              ),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTextStyles.bodyMedium.copyWith(
                      ...
                      fontWeight: _selectedGrade != null && grades.contains(_selectedGrade)
                          ? FontWeight.w600
                          : FontWeight.normal,
                    ),
                  ),
