              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildSection(
                      title: '제 1 조 (목적)',
                      content: '''본 약관은 MathLab(이하 "서비스")의 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.''',
                    ),
...
3. 회사가 약관을 변경할 경우에는 적용일자 및 변경사유를 명시하여 현행약관과 함께 서비스 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다.''',
                    ...
                    _buildSection(
                      title: '제 4 조 (회원가입)',
                      content: '''1. 회원가입은 이용자가 약관의 내용에 대하여 동의를 한 다음 회원가입 신청을 하고 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.
