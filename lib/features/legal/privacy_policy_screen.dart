                ...
                child: Column(
                  ...
                  children: [
                    _buildSection(
                      title: '1. 개인정보의 처리 목적',
                      content:
                          '''MathLab은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
...
학습 콘텐츠 제공, 학습 진도 관리, 맞춤형 학습 서비스 제공, 본인인증 등의 목적으로 개인정보를 처리합니다.''',
                    ...
                    _buildSection(
                      ...
                      content:
                          '''① MathLab은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
...
나. 선택항목
   ...
   - 기기 정보 (앱 사용 기록)''',
                    ...
                    _buildSection(
                      ...
                      content:
                          '''① MathLab은 원칙적으로 정보주체의 개인정보를 수집·이용 목적으로 명시한 범위 내에서 처리하며, 다음의 경우를 제외하고는 정보주체의 사전 동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다:
   ...
   - 정보주체 또는 법정대리인이 의사표시를 할 수 없는 상태에 있거나 주소불명 등으로 사전 동의를 받을 수 없는 경우로서 명백히 정보주체 또는 제3자의 급박한 생명, 신체, 재산의 이익을 위하여 필요하다고 인정되는 경우''',
                    ...
                    _buildSection(
                      title: '5. 개인정보처리의 위탁',
                      content:
                          '''① MathLab은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다:
...
② MathLab은 위탁계약 체결 시 개인정보 보호법 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리·감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.''',
                    ...
                    _buildSection(
                      ...
                      content:
                          '''① 정보주체는 MathLab에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
...
③ 개인정보 열람 및 처리정지 요구는 개인정보보호법 제35조 제4항, 제37조 제2항에 의하여 정보주체의 권리가 제한될 수 있습니다.''',
                    ...
                    _buildSection(
                      title: '7. 개인정보의 파기',
                      content:
                          '''① MathLab은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
...
나. 파기방법
   ...
   - 종이에 출력된 개인정보: 분쇄기로 분쇄하거나 소각''',
                    ...
                    _buildSection(
                      title: '8. 개인정보 보호책임자',
                      content:
                          '''① MathLab은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다:
...
3. 물리적 조치: 전산실, 자료보관실 등의 접근통제''',
                    ...
                    _buildSection(
                      ...
                      content:
                          '''① MathLab은 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다.
